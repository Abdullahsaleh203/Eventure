...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    # Optional: You can add a create method if needed,
    # although profiles are typically created automatically via signals.
...
class EventSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.title = validated_data.get(
            'title',
            instance.title)
        instance.event_type = validated_data.get(
            'event_type',
            instance.event_type)
        ...
        instance.location = validated_data.get(
            'location',
            instance.location)
        instance.reminders = validated_data.get(
            'reminders',
            instance.reminders)
        ...
        if schedule_data:
            instance.schedule.all_day = schedule_data.get(
                'all_day',
                instance.schedule.all_day)
            instance.schedule.start_at = schedule_data.get(
                'start_at',
                instance.schedule.start_at)
            instance.schedule.end_at = schedule_data.get(
                'end_at',
                instance.schedule.end_at)
            instance.schedule.repeat = schedule_data.get(
                'repeat',
                instance.schedule.repeat)
